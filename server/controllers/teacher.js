...
module.exports = {
        ...
        .then((data) => {
            if (!data) {
                ...
                return res.status(200).json({ 
                    success: true, message: 'Succesfully created teacher', teacher: data 
                }).end();
            }
        })
        .catch((err) => {
    ...
    deleteTeacher: function(req, res, next){
      ...
      .then(function() {
          return res.status(200).send({"msg": "Succesfully deleted teacher."}).end();
      })
      .catch(function(err) {
          console.log(err);
    ...
    updateTeacher: function (req, res, next) {
      ...
      .then((data) => {
        return res.status(200).json({ 
                  success: true, message: 'Succesfully updated teacher', teacher: data 
              }).end();
      })
      .catch((error) => {
        console.log(err);
